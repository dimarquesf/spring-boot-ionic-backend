...
import br.com.diego.cursomc.dto.ClienteDTO;
import br.com.diego.cursomc.dto.ClienteNewDTO;
...
import br.com.diego.cursomc.services.exception.AuthorizationException;
import br.com.diego.cursomc.services.exception.DataIntegrityException;
...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		//pe.encode = senha vai ser encodada com algoritimo bcScprit
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		jpgImage = imageService.cropSquare(jpgImage);//recorta imagem para quadrado
