...
import br.com.diego.cursomc.domain.PagamentoComBoleto;
import br.com.diego.cursomc.domain.PagamentoComCartao;
import br.com.diego.cursomc.domain.Pedido;
import br.com.diego.cursomc.domain.Produto;
import br.com.diego.cursomc.domain.enums.EstadoPagamento;
...
import br.com.diego.cursomc.repositories.ItemPedidoRepository;
import br.com.diego.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4)); //Associações de Categorias com Produto ( mão dupla)
		...
		Endereco e1 = new Endereco(null, "Rua 1", "1", "Casa 1", "Jardim 1", "11111-111", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua 2", "2", "Casa 2", "Jardim 2", "22222-222", cli1, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("08/04/2020 21:49"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/04/2020 21:49"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1,6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("09/04/2020 00:00"),null);
